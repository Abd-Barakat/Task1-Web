<%@ Page Title="Edit"   Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_Page.Master" CodeBehind="Edit_dialog.aspx.cs" Inherits="Web.Edit_dialog" %>
...
<asp:Content  ID="Try" ContentPlaceHolderID="RadioButtonsPlaceHolder" runat="server" >
